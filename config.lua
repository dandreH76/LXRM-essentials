...
ConsumeablesEat = {
    ["bread"] = {hunger = math.random(15, 25), 	metaweight = 0.6},
    ["stew"] = {hunger = math.random(15, 25), 	metaweight = 0.3},
    ["cooked_meat"] = {hunger = math.random(15, 25), 	metaweight = 0.4},
    ["cooked_fish"] = {hunger = math.random(15, 25), 	metaweight = 0.4},
}

ConsumeablesDrink = {
    ["water"] =  {thirst = math.random(35, 54), 	metaweight = 0.2},
}

Config.Discord = {
    ["discord_id"]              = 1013597227740049549,
    ["discord_joinurl"]         = "https://discord.gg/x46TVD8WN4",
    ["discord_connecturl"]      = "redm://connect/127.0.0.1",
    ["discord_big_image"]       = "untitled-2_1_",
    ["discord_small_image"]     = "untitled-2_1_",
}

-- discord webhook config
Config.DiscordWHImage = 'https://cdn.discordapp.com/attachments/1082254739825246269/1082255410595119104/Untitled-2.png'
Config.DiscordWHLogUserName = 'LXRM Logs'
Config.DiscordWHAuthorName = 'LXRM - RDR2'
