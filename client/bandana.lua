...
RegisterNetEvent('LXRM-bandana:client:ToggleBandana')
AddEventHandler('LXRM-bandana:client:ToggleBandana', function()
    local ped = PlayerPedId()
    local male = IsPedMale(ped)
    local neckwear = exports['LXRM-clothes']:GetClothesCurrentComponentHash('neckwear')

    -- Beard of Power: https://www.nexusmods.com/skyrimspecialedition/mods/42635
    -- local beardofpower = exports['LXRM-appearance']:GetBodyCurrentComponentHash('beard')
